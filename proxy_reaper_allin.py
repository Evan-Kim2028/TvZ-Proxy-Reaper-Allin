...
#Issue - Reaper needs to recognize terrain (cliff).
#Issue - Reaper needs to target fire
#Issue - Reaper needs to retreat properly
#Issue - Reaper grenade is ineffective
